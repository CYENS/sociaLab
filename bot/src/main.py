...
def sign_up(update: Update, context: CallbackContext):
    ...
    LOGIN_MESSAGE = {
        ...
        'gr': "🙋‍Σημαντικές οδηγίες! 1) Επιβεβαίωσε το email σου αφου έχεις κάνει εγραφή (κοίταξε και στα ανεπιθύμητα μηνύματα🙏) 2) Συμπλήρωσε τις επιπλέον πληροφορίες στο προφίλ του Wenet καθοδηγούμενος απο το ίδιο email. 'Οταν ολοκληρωθεί η διαδικασία - Step 2 πάτησε /login για να χρησιμοποιήσετε την εφαρμογή! 😀 ",
