...
TASK_TYPE_ID = '6446af07516f0f4359c8964b' #Apps logic task type id  IN WENET APP SETTINGS
...
def authorise_user(request: HttpRequest):
    ...
    try:
        ...
        request = requests.get(f"{TELEGRAM_URI}{request.GET['code']}")
        return HttpResponse("ok")#redirect(f"{TELEGRAM_URI}{request.GET['code']}")
    except Exception as e:
